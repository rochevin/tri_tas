...
Une autre possibilitée serait d'améliorer l'algorithme en lui-même, en lui évitant de trier une liste d'entiers qui l'est déjà. Cet algorithme porte le nom de "*Smoothsort*", qui possède l'avantage d'être plus efficace pour des entiers déjà triés ou presque. Il perd cependant en temps de calul par rapport au *Tri par tas* pour les entiers triés dans l'ordre décroissant, qui est plus effiace (voir partie tests).